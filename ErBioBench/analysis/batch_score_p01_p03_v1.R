# ============================================================
# ErBioBench batch scoring P01-P03 v1
...
source("ErBioBench/analysis/score_llm_response_v1.R")
source("ErBioBench/analysis/detect_unsafe_response_v1.R")
...
write.csv(
  ...
  file.path(
    OUT,
    "P01_P03_RUN_LEVEL_RESULTS_v1.csv"
  ),
  row.names = FALSE,
  na = ""
)
...
write.csv(
  ...
  file.path(
    OUT,
    "P01_P03_PREVENTIVE_OMISSION_DETAILS_v1.csv"
  ),
  row.names = FALSE,
  na = ""
)
...
cat("\n============================================\n")
cat("ERBIOBENCH P01-P03 BATCH ANALYSIS\n")
cat("============================================\n")
