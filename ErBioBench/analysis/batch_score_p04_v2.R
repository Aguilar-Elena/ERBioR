...
source("ErBioBench/analysis/detect_unsafe_response_v3.R")
...
write.csv(
  ...
  file.path(
    OUT,
    "P04_PREVENTIVE_OMISSION_DETAILS_v2.csv"
  ),
  row.names = FALSE,
  na = ""
)
...
cat("\n============================================\n")
cat("ERBIOBENCH P04 BATCH ANALYSIS v2\n")
cat("============================================\n")
