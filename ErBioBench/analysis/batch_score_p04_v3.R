...
write.csv(
  ...
  file.path(
    OUT,
    "P04_PREVENTIVE_OMISSION_DETAILS_v3.csv"
  ),
  row.names = FALSE,
  na = ""
)
...
cat("\n============================================\n")
cat("ERBIOBENCH P04 BATCH ANALYSIS v3\n")
cat("============================================\n")
